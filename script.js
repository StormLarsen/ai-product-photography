...
document.querySelectorAll('.feature-card, .pricing-card, .step, .use-case, .faq-item').forEach(el => {
    el.style.opacity = '0';
...
// Add hover effect to demo card
const demoPreview = document.querySelector('.demo-preview');
if (demoPreview) {
    demoPreview.addEventListener('mouseenter', () => {
        demoPreview.style.transform = 'scale(1.05)';
        demoPreview.style.transition = 'transform 0.3s ease';
    });
